...
for (let i = 1; i <= 3; i++) {
  ...
  $("#atkName" + i+"Val").on("input", function () {
    ...
    $("#atk" + i + "Name").html($("#atkName" + i + "Val").val());
    switch (i) {
      case 1 : NameAtt1 = $("#atkName" + i + "Val").val()
      case 2 : NameAtt2 = $("#atkName" + i + "Val").val()
      case 3 : NameAtt3 = $("#atkName" + i + "Val").val()
    }
    card = updateCard();
  })
  ...
  $("#atkPower" + i + "Val").on("input", function () {
    ...
    $("#atk" + i + "Power").html($("#atkPower" + i + "Val").val());
    switch (i) {
      case 1 : DamageAtt1 = $("#atkPower" + i + "Val").val()
      case 2 : DamageAtt2 = $("#atkPower" + i + "Val").val()
      case 3 : DamageAtt3 = $("#atkPower" + i + "Val").val()
    }
    card = updateCard();
  })
  ...
  $("#atkMana" + i + "Val").on("input", function () {
    ...
    $("#atk" + i + "Mana").html($("#atkMana" + i + "Val").val());
    switch (i) {
      case 1 : ManaAtt1 = $("#atkMana" + i + "Val").val()
      case 2 : ManaAtt2 = $("#atkMana" + i + "Val").val()
      case 3 : ManaAtt3 = $("#atkMana" + i + "Val").val()
    }
    card = updateCard();
  })
  ...
  $("#atk" + i + "Desc").html($("#atkDesc" + i + "Val").val());
  switch (i) {
      case 1 : DescAtt1 = $("#atkDesc" + i + "Val").val()
      case 2 : DescAtt2 = $("#atkDesc" + i + "Val").val()
      case 3 : DescAtt3 = $("#atkDesc" + i + "Val").val()
    }
    card = updateCard();
  })
}
...
for (let i = 1; i <= 3; i++) {
  $("#atk" + i + "IconeValue").on("input", function () {
    ...
    switch (i) {
      case 1 : IcoAtt1 = $(this).val()
      case 2 : IcoAtt2 = $(this).val()
      case 3 : IcoAtt3 = $(this).val()
    }
    card = updateCard();
  })
}
